...
class M5StackCoreS3Board : public WifiBoard {
    public:
    // 🌟 暴露出底层的 SPI 句柄，留给 main.cpp 里的 LVGL 用
...
public:
    ...
    // virtual AvatarBridgeDisplay* GetDisplay() override {
    //     return bridge_display_;
    // }
    ...
    virtual Display* GetDisplay() override {
        // 当小智的 application.cc 来要屏幕时，把我们的伪装者交出去！
        return bridge_display_;
    }
};
